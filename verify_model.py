...
def main(model_path, classes_path, image_size):
    ...
    for label in ["autorickshaw", "car", "van"]:        
        ...
        image_dir = r"D:\One Drive Bennett\OneDrive - BENNETT UNIVERSITY\IV2 project\verification_images"
        ...
        # predict
        image = trans(image)
        pred_outs = sess.run(None, {input_name: image.unsqueeze(0).numpy()})[0][0]
